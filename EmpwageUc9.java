...
public class EmpwageUc9 {
    ...
    EmpwageUc9(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
    ...
    {
    	EmpwageUc9 google = new EmpwageUc9("Google", 8, 20, 100);
    	EmpwageUc9 microsoft = new EmpwageUc9("Microsoft", 4, 30, 150);
